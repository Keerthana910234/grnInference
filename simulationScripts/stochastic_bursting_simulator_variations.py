...
#   degradation of TF mRNA
    ...
    k_on_TF_adjusted = k_on_TF*(TF_Target_link_function(Target_protein_1K, Target_TF_link_EC50, n, 16))
...
def get_average_numbers_both_TF(
    ...
    max_effect=16.0, TF_hill=0.5, t_max=1000, **kwargs
):
    """Returns TF and Target steady-state protein levels. Calculated using ODE45 solver"""

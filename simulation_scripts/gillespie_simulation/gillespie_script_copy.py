...
def is_steady_state(samples, time_points, mean_tol=0.05, std_tol=0.05,
                    slope_tol=0.05, window_frac=0.25, verbose=True):
    """
...
if __name__ == "__main__":
    ...
    base_config = {
        ...
        "param_csv":      "/home/mzo5929/Keerthana/grnInference/simulation_data/gillespie_simulation_test/sim_details/effect_of_radd_positive.csv",
        "param_to_start":      0,
